...
app.get('/regression_choice', function(req, res){
  res.render('regression_choice');
});
...
app.get('/final_page', function(req, res){
...
app.get('/cookie', function(req, res){
  ...
  res.cookie('username', 'Will', {expire : new Date() + 9999}).send('username has the value of : Will');
});
